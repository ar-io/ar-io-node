...
// Full unbundling backlog. bundle_repair_pending_bundles only counts the
// matched_data_item_count > 0 subset — bundles that already unbundled once
// — so it under-reports total outstanding work by orders of magnitude when
// most of the backlog has never been successfully unbundled. This gauge is
// the complete picture.
export const bundleRepairBacklogBundlesGauge = new promClient.Gauge({
  name: 'bundle_repair_backlog_bundles',
