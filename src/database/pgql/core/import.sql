...
INSERT INTO new_transaction_tags (
    ...
    height, indexed_at
             ...
             @transaction_id, @transaction_tag_index,
             @height, @indexed_at
         ) ON CONFLICT (tag_name_hash, tag_value_hash, transaction_id) DO UPDATE SET
    height = COALESCE(EXCLUDED.height, new_transaction_tags.height);
...
INSERT INTO new_transactions (
    ...
    height = COALESCE(@height, new_transactions.height);
